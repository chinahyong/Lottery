...
public class WheelView extends View {
	/** Scrolling duration 滚动持续的时间 */
	private static final int SCROLLING_DURATION = 400;

	/** Minimum delta for scrolling 最少滚动的位置 */
	private static final int MIN_DELTA_FOR_SCROLLING = 1;

	/** Current value & label text color 当前值和标签的颜色 */
	private static final int VALUE_TEXT_COLOR = 0xFF4d4d4d;

	/** Items text color item文字的颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFF787878;

	/** Top and bottom shadows colors 顶部和底部阴影的颜色 */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111,
			0x004d4d4d, 0x004d4d4d };
	...
	/** Text size 字体大小 */
	public int TEXT_SIZE = dip2px(getContext(), 17);

	/** Top and bottom items offset (to hide that) 顶部和底部item的偏移值 */
	private final int ITEM_OFFSET = TEXT_SIZE / 5;

	/** Additional width for items layout item布局的附加宽度 */
	private static final int ADDITIONAL_ITEMS_SPACE = 10;

	/** Label offset 标签偏移值 */
	private static final int LABEL_OFFSET = 8;

	/** Left and right padding value 左右padding值 */
	private static final int PADDING = 10;

	/** Default count of visible items 默认可见的item数目 */
	private static final int DEF_VISIBLE_ITEMS = 5;

	// Wheel Values 初始化wheeladpate
	...
	// Count of visible items 可见item数目
