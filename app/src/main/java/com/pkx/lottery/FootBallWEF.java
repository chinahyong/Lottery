...
public class FootBallWEF extends Activity implements OnClickListener {
	private ManagementListView footballList;
	private WEFManagementAdapter myadapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.football_wef);
		mIntent = getIntent();
		...
		myadapter = new WEFManagementAdapter(this, footballList, dayMatchses,
				handler);
