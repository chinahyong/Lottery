...
public class ShowHappy extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initviews();
		// 测试往期数据
		PeroidRes res = new PeroidRes("getPeroidRes", "7", "30", "1");
		...
		Net.post(true, ShowHappy.this, Constant.POST_URL + "/data.api.php",
	...
	private void initviews() {
		...
		showPullList.setOnRefreshListener(new OnRefreshListener2<ListView>() {
			...
			public void onPullDownToRefresh(
				...
				PeroidRes res = new PeroidRes("getPeroidRes", "7", "30", String
						.valueOf(1));
				...
				params.put("SN", sutil.getSN());
				params.put("DATA", miwen);
				Net.post(false, ShowHappy.this, Constant.POST_URL
...
//				PeroidRes res = new PeroidRes("getPeroidRes", "7", "30",
//						String.valueOf(1));
//				String miwen = MDUtils.MDEncode(sutil.getdeviceKEY(),
//						Net.gson.toJson(res));
//				RequestParams params = new RequestParams();
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 60888) {
				...
				params.put("SN", sutil.getSN());
				params.put("DATA", miwen);
				Net.post(true, ShowHappy.this, Constant.POST_URL
				...
				if (msg.arg1 == Constant.NET_ACTION_LOTHIS) {
					...
					try {
						if ("0".equals(djo.getString("error"))) {
							Log.e("pkx", "toDetails");
							Intent toLottDetails = new Intent(ShowHappy.this,
...
//						Toast.makeText(ShowHappy.this, "加载成功",
...
//						showList.stopRefresh();
						...
						Toast.makeText(ShowHappy.this, "刷新成功",
								Toast.LENGTH_SHORT).show();
					} catch (JSONException e) {
						Log.e("pkx", "ja------>JSONException");
						e.printStackTrace();
				...
				showPullList.onRefreshComplete();
				Toast.makeText(ShowHappy.this, "加载失败", Toast.LENGTH_SHORT)
						.show();
			}
		}
	}
