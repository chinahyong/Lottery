...
public class PointsManagementAdapter extends BaseExpandableListAdapter
	...
	private int brownText = Color.parseColor("#904c0f");
	private int blueText = Color.parseColor("#275783");
	private int greenText = Color.parseColor("#246423");
	...
	public PointsManagementAdapter(Context context,
			ManagementListView listView, ArrayList<DayMatchs> dayMatchses,
			Handler handler) {
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		// } else {
		// matchShowView.setBackgroundResource(R.drawable.points_rect_red);
		// }
	...
	private OnClickListener footBallBetListener = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			for (int i = 23; i < clickViews.size(); i++) {
				if (v == clickViews.get(i)) {
					if (Constant.MATCH_STATUS.get(fullGroupPositin)
						...
						if(i<36){
							Log.e("pkx", "brown----i="+i+"  "+clickTexts.get(i).getText());
							clickTexts.get(i).setTextColor(brownText);
						}else if(i>36&&i<41){
							clickTexts.get(i).setTextColor(blueText);
							Log.e("pkx", "blue----i="+i+"  "+clickTexts.get(i).getText());
						}else{
							clickTexts.get(i).setTextColor(greenText);
							Log.e("pkx", "green----i="+i+"  "+clickTexts.get(i).getText());
						}
						Constant.MATCH_STATUS.get(fullGroupPositin)
	...
	private void alertFootballBet(Context ctx, int groupPos, int childPos,
		...
		alert.show();
		alert.getWindow().setContentView(R.layout.football_points_dialog);
		...
		for(int i=0;i<31;i++){
			if(i<13){
				textviews1.get(i+23).setTextColor(brownText);
			}else if(i>13&&i<18){
				textviews1.get(i+23).setTextColor(blueText);
			}else{
				textviews1.get(i+23).setTextColor(greenText);
			}
			Log.e("pkx", "-------points-----"+i+textviews1.get(i+23).getText());
		}
		...
		ArrayList<TextView> pointViews = new ArrayList<TextView>();
		pointViews.add(d_whole_lelse_text);
		pointViews.add(d_whole_eeelse_text);
		pointViews.add(d_whole_welse_text);
		pointViews.add(d_whole_00_text);
		pointViews.add(d_whole_01_text);
		pointViews.add(d_whole_02_text);
		pointViews.add(d_whole_03_text);
		pointViews.add(d_whole_04_text);
		pointViews.add(d_whole_05_text);
		pointViews.add(d_whole_10_text);
		pointViews.add(d_whole_11_text);
		pointViews.add(d_whole_12_text);
		pointViews.add(d_whole_13_text);
		pointViews.add(d_whole_14_text);
		pointViews.add(d_whole_15_text);
		pointViews.add(d_whole_20_text);
		pointViews.add(d_whole_21_text);
		pointViews.add(d_whole_22_text);
		pointViews.add(d_whole_23_text);
		pointViews.add(d_whole_24_text);
		pointViews.add(d_whole_25_text);
		pointViews.add(d_whole_30_text);
		pointViews.add(d_whole_31_text);
		pointViews.add(d_whole_32_text);
		pointViews.add(d_whole_33_text);
		pointViews.add(d_whole_40_text);
		pointViews.add(d_whole_41_text);
		pointViews.add(d_whole_42_text);
		pointViews.add(d_whole_50_text);
		pointViews.add(d_whole_51_text);
		pointViews.add(d_whole_52_text);
		for (int i = 0; i < pointViews.size(); i++) {
			pointViews.get(i).setText(
					Constant.MIX_DAYMATCHESS.get(groupPos).getMatchs()
							.get(childPos).getScore_odds().get(i));
		}
		for (int i = 23; i < views.size(); i++) {
			if (Constant.MATCH_STATUS.get(fullGroupPositin)
					.get(fullChildposition).get(i) == 0) {
				views.get(i).setBackgroundResource(R.drawable.cp);
				if(i<13+23){
					textviews1.get(i).setTextColor(brownText);
				}else if(i>13+23&&i<18+23){
					textviews1.get(i).setTextColor(blueText);
				}else{
					textviews1.get(i).setTextColor(greenText);
				}
