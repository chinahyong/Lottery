...
public class ShowChongqing extends Activity{
//	private XListView showList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initviews();
		// 测试往期数据
		PeroidRes res = new PeroidRes("getPeroidRes", "6", "30", "1");
		...
		Net.post(true, ShowChongqing.this, Constant.POST_URL+"/data.api.php",
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					convertView = inflater.inflate(
							R.layout.showchongqing_list_item, null);
...
//							.findViewById(R.id.balltext8);
				...
				if (lotts.get(position).getBalls().size() == 5) {
...
//							.getBalls().get(7)));
		...
		showPullList.setOnRefreshListener(new OnRefreshListener2<ListView>() {
					...
					public void onPullDownToRefresh(
						...
						Log.e("pkx",
								"exhibitionRefreshView-----onPullDownToRefresh");
						PeroidRes res = new PeroidRes("getPeroidRes", "6", "30",
								String.valueOf(1));
						...
						params.put("SN", sutil.getSN());
						params.put("DATA", miwen);
						Net.post(false, ShowChongqing.this,
					...
					public void onPullUpToRefresh(
							PullToRefreshBase<ListView> refreshView) {
						Log.e("pkx",
								"exhibitionRefreshView-----onPullUpToRefresh");
						PeroidRes res = new PeroidRes("getPeroidRes", "6", "30",
...
//				params.put("SN", sutil.getSN());
//				params.put("DATA", miwen);
//				Net.post(true, ShowChongqing.this,
//						Constant.POST_URL+"/lottery.api.php", params,
				...
				if (msg.arg1 == Constant.NET_ACTION_LOTHIS) {
					...
					try {
						if ("0".equals(djo.getString("error"))) {
							Log.e("pkx", "toDetails");
							Intent toLottDetails = new Intent(ShowChongqing.this,
...
//						Toast.makeText(ShowChongqing.this, "加载成功",
//								Toast.LENGTH_SHORT).show();
					...
					try {
						...
						Toast.makeText(ShowChongqing.this, "刷新成功",
								Toast.LENGTH_SHORT).show();
					} catch (JSONException e) {
						Log.e("pkx", "ja------>JSONException");
						e.printStackTrace();
				...
				showPullList.onRefreshComplete();
				Toast.makeText(ShowChongqing.this, "加载失败", Toast.LENGTH_SHORT)
						.show();
			}
		}
	}
