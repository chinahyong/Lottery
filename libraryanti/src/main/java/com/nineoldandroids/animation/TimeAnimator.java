 ...
 * com.nineoldandroids.animation frame to its TimeListener (if set), with information about this animator,
 * the total elapsed time, and the time since the last com.nineoldandroids.animation frame.
 *
 * @hide
 */
public class TimeAnimator extends ValueAnimator {
     ...
     * an com.nineoldandroids.animation.
     *
     ...
     * to a <code>TimeAnimator</code> instance to receive callbacks on every com.nineoldandroids.animation
    ...
    public static interface TimeListener {
        /**
         * <p>Notifies listeners of the occurrence of another frame of the com.nineoldandroids.animation,
