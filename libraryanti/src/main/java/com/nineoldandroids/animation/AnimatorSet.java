 ...
 * its animations. For example, an com.nineoldandroids.animation a1 could be set up to start before com.nineoldandroids.animation a2, a2
...
public final class AnimatorSet extends Animator {
     ...
     * previous com.nineoldandroids.animation ends.
     *
     ...
     * of this AnimatorSet.
     *
     * @param interpolator the interpolator to be used by each child com.nineoldandroids.animation of this AnimatorSet
     */
    @Override
     ...
     * tells the <code>Builder</code> the com.nineoldandroids.animation that is the dependency for
     ...
     * <code>Builder</code> the com.nineoldandroids.animation upon which the dependency is created,
     ...
     *
     * @param anim The com.nineoldandroids.animation that is the dependency used in later calls to the
     ...
     *
     * @return The length of the com.nineoldandroids.animation, in milliseconds, of each of the child
     ...
     * each child com.nineoldandroids.animation will use its own duration. If the duration is set on the AnimatorSet,
     * then each child com.nineoldandroids.animation inherits this duration.
     *
     * @param duration The length of the com.nineoldandroids.animation, in milliseconds, of each of the child
     * animations of this AnimatorSet.
     */
    @Override
    ...
    public void start() {
        ...
        // contains the com.nineoldandroids.animation nodes in the correct order.
        sortNodes();
        ...
        // dependencies on all of the nodes. For example, we don't want to start an com.nineoldandroids.animation
        // when some other com.nineoldandroids.animation also wants to start when the first com.nineoldandroids.animation begins.
    ...
    public AnimatorSet clone() {
         ...
         * manually, as we clone each Node (and its com.nineoldandroids.animation). The clone will then be sorted,
     ...
     * animations. If an com.nineoldandroids.animation has multiple dependencies on other animations, then
     * all dependencies must be satisfied before the com.nineoldandroids.animation is started.
     */
    private static class DependencyListener implements AnimatorListener {
         ...
         * com.nineoldandroids.animation is canceled.
         */
         ...
         * the com.nineoldandroids.animation.
         * @param dependencyAnimation the com.nineoldandroids.animation that sent the event.
         */
        private void startIfReady(Animator dependencyAnimation) {
            ...
            for (int i = 0; i < numDependencies; ++i) {
                ...
                if (dependency.rule == mRule &&
                    ...
                    // see whether it's time to start the com.nineoldandroids.animation
            ...
            if (mNode.tmpDependencies.size() == 0) {
                // all dependencies satisfied: start the com.nineoldandroids.animation
    ...
    private class AnimatorSetListener implements AnimatorListener {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (!mTerminated) {
                ...
                if (allDone) {
                    // If this was the last child com.nineoldandroids.animation to end, then notify listeners that this
    ...
    private static class Node implements Cloneable {
        ...
        /**
         *  These are the dependencies that this node's com.nineoldandroids.animation has on other
         *  nodes. For example, if this node's com.nineoldandroids.animation should begin with some
         *  other com.nineoldandroids.animation ends, then there will be an item in this node's
         *  dependencies list for that other com.nineoldandroids.animation's node.
         */
        ...
        /**
         * Flag indicating whether the com.nineoldandroids.animation in this node is finished. This flag
         * is used by AnimatorSet to check, as each com.nineoldandroids.animation ends, whether all child animations
         * are done and it's time to send out an end event for the entire AnimatorSet.
         */
        public boolean done = false;

        /**
         * Constructs the Node with the com.nineoldandroids.animation that it encapsulates. A Node has no
         * dependencies by default; dependencies are added via the addDependency()
         * method.
         *
         * @param animation The com.nineoldandroids.animation that the Node encapsulates.
         */
     ...
     * multiple relationships. However, note that it is only the com.nineoldandroids.animation passed into the initial
    ...
    public class Builder {
         ...
         *
         * @param anim The com.nineoldandroids.animation that is the dependency for the other animations passed into
        ...
        /**
         * Sets up the given com.nineoldandroids.animation to play at the same time as the com.nineoldandroids.animation supplied in the
         * {@link AnimatorSet#play(Animator)} call that created this <code>Builder</code> object.
         *
         * @param anim The com.nineoldandroids.animation that will play when the com.nineoldandroids.animation supplied to the
        ...
        /**
         * Sets up the given com.nineoldandroids.animation to play when the com.nineoldandroids.animation supplied in the
         * {@link AnimatorSet#play(Animator)} call that created this <code>Builder</code> object
         * ends.
         *
         * @param anim The com.nineoldandroids.animation that will play when the com.nineoldandroids.animation supplied to the
         ...
         * Sets up the given com.nineoldandroids.animation to play when the com.nineoldandroids.animation supplied in the
         * {@link AnimatorSet#play(Animator)} call that created this <code>Builder</code> object
         * to start when the com.nineoldandroids.animation supplied in this method call ends.
         *
         * @param anim The com.nineoldandroids.animation whose end will cause the com.nineoldandroids.animation supplied to the
        ...
        /**
         * Sets up the com.nineoldandroids.animation supplied in the
         * {@link AnimatorSet#play(Animator)} call that created this <code>Builder</code> object
         * to play when the given amount of time elapses.
         *
         * @param delay The number of milliseconds that should elapse before the
         * com.nineoldandroids.animation starts.
         */
