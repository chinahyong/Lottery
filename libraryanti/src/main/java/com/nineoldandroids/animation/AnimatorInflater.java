...
public class AnimatorInflater {
     ...
     * @param id The resource id of the com.nineoldandroids.animation to load
     * @return The animator object reference by the specified id
     * @throws NotFoundException when the com.nineoldandroids.animation cannot be loaded
     */
    public static Animator loadAnimator(Context context, int id)
        ...
        try {
            ...
            NotFoundException rnf =
                    new NotFoundException("Can't load com.nineoldandroids.animation resource ID #0x" +
    ...
    /**
     * Creates a new com.nineoldandroids.animation whose parameters come from the specified context and
     * attributes set.
     *
     * @param context the application environment
     * @param attrs the set of attributes holding the com.nineoldandroids.animation parameters
     */
