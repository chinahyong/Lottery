...
/**
 * This class enables automatic and optimized com.nineoldandroids.animation of select properties on View objects.
 ...
 * are well equipped to do the right thing to set the property and invalidate the com.nineoldandroids.view
