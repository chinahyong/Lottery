...
/**
 * A proxy class to allow for modifying post-3.0 com.nineoldandroids.view properties on all pre-3.0
...
public final class AnimatorProxy extends Animation {
    ...
    /**
     * Create a proxy to allow for modifying post-3.0 com.nineoldandroids.view properties on all
    ...
    public static AnimatorProxy wrap(View view) {
        ...
        // This checks if the proxy already exists and whether it still is the com.nineoldandroids.animation of the given com.nineoldandroids.view
